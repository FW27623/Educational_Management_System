...
<body>
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/editCourse" id="editfrom" method="post">
							  ...
							  <div class="form-group">
								  ...
								  <div class="col-sm-10">
									  <label for="teacherid"></label><select class="form-control" name="teacherid" id="teacherid">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<label for="coursetype"></label><select class="form-control" name="coursetype" id="coursetype">
	...
	<script type="text/javascript">
		...
		const degreeSelect = $("#coursetype option");
		for (i = 0; i<coursetypeSelect.length; i++) {
            if (coursetypeSelect[i].value === '${course.coursetype}') {
                coursetypeSelect[i].selected = true;
            }
        }

		const teacheridSelect = $("#teacherid option");
		for (i = 0; i<teacheridSelect.length; i++) {
