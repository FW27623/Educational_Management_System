...
<body>
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/editTeacher" id="editfrom" method="post">
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-10">
									<label for="degree"></label><select class="form-control" name="degree" id="degree">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<label for="title"></label><select class="form-control" name="title" id="title">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
									<label for="college"></label><select class="form-control" name="collegeid" id="college">
	...
	<script type="text/javascript">
		...
		const collegeSelect = $("#college option");
		for (i = 0; i<collegeSelect.length; i++) {
            if (collegeSelect[i].value === '${teacher.collegeid}') {
                collegeSelect[i].selected = true;
            }
        }

		const degreeSelect = $("#degree option");
		const titleSelect = $("#title option");

		for (i = 0; i<degreeSelect.length; i++) {
            if (degreeSelect[i].value === '${teacher.degree}') {
                degreeSelect[i].selected = true;
            }
        }
        for (i = 0; i<titleSelect.length; i++) {
