...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/userPasswordRest">账号密码重置<sapn class="glyphicon glyphicon-repeat pull-right"></sapn></a></li>
        <li><a href="${pageContext.request.contextPath}/admin/passwordRest">修改密码<sapn class="glyphicon glyphicon-pencil pull-right"></sapn></a></li>
